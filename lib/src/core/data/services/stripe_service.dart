...
class StripeService {
  ...
  StripeService._internal() {
    ...
    StripePayment.setOptions(
      StripeOptions(
        merchantId: AppConstants.applePayMerchantId,
        publishableKey: AppConstants.stripePublishableKey,
        androidPayMode: AppConstants.stripeAndroidPayMode,
      ),
    );
  }
  ...
  Future<bool> checkIfNativePayReady() async {
    ...
    var isNativeReady = await StripePayment.canMakeNativePayPayments(
        AppConstants.stripeSupportedCards);
  ...
  Future<void> processPaymentAsDirectCharge(
    ...
    const url = AppConstants.stripeCloudFunctionUrl;
    _logger.d('ID: ${paymentMethod.id}');
