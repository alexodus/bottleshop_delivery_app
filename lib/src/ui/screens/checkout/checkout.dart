...
import 'package:bottleshopdeliveryapp/src/ui/shared/CreditCardsWidget.dart';
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            SizedBox(
              ...
              child: FlatButton(
                onPressed: () {
                  Navigator.pushNamed(context, CheckoutDoneScreen.routeName);
                },
              ...
              children: <Widget>[
                SizedBox(
                  ...
                  child: FlatButton(
                    onPressed: () {
                      Navigator.pushNamed(
                          context, CheckoutDoneScreen.routeName);
                    },
