...
class _CategoryDetailViewState extends State<CategoryDetailView> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    _tabController =
        TabController(length: _subCategoriesList.length, initialIndex: widget.routeArgument.id, vsync: this);
    ...
    return Scaffold(
      ...
      body: CustomScrollView(slivers: <Widget>[
        SliverAppBar(
          ...
          leading: IconButton(
            icon: FaIcon(FontAwesomeIcons.arrowLeft, color: Theme.of(context).primaryColor),
