...
class CategoryDetailView extends StatefulWidget {
  ...
  CategoryDetailView({Key key}) : super(key: key);
...
class _CategoryDetailViewState extends State<CategoryDetailView>
  ...
  void initState() {
    _tabController = TabController(
        length: _subCategoriesList.length, initialIndex: 0, vsync: this);
  ...
  Widget build(BuildContext context) {
    ...
    debugPrint('product detail args: $args');
    return Scaffold(
      key: _scaffoldKey,
      drawer: MenuDrawer(),
        ...
        slivers: <Widget>[
          ...
          SliverToBoxAdapter(
            child: ProductsByCategory(
              subCategory: _subCategoriesList.elementAt(args.argumentsList[1]),
